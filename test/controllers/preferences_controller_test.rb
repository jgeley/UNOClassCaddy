...
class PreferencesControllerTest < ActionController::TestCase
  ...
  test "should create preference" do
    assert_difference('Preference.count') do
      post :create, preference: { endTime: @preference.endTime, kind: @preference.kind, sessionid: @preference.sessionid, startTime: @preference.startTime }
    end
  ...
  test "should update preference" do
    patch :update, id: @preference, preference: { endTime: @preference.endTime, kind: @preference.kind, sessionid: @preference.sessionid, startTime: @preference.startTime }
    assert_redirected_to preference_path(assigns(:preference))
  end
